  ...
  return (
    <div className="draftout-card rounded-2xl p-6 sm:p-8 shadow-cyan-glow max-w-lg w-full transition-all">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Info Note */}
        <p className="text-[11px] text-cyan-400/70 bg-cyan-950/30 p-3 rounded-lg border border-cyan-500/20 leading-relaxed font-mono">
          💡 You can customize Board Size grid and Turn Timer directly inside your lobby room!
        </p>
